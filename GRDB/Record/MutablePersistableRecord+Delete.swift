...
extension MutablePersistableRecord {
    @inline(__always)
    @inlinable
    public func willDelete(_ db: DatabaseBase<some SQLiteAPI>) throws { }
    
    @inline(__always)
    @inlinable
    public func aroundDelete(_ db: DatabaseBase<some SQLiteAPI>, delete: () throws -> Bool) throws {
        _ = try delete()
    }
...
extension MutablePersistableRecord {
    ...
    public func delete(_ db: DatabaseBase<some SQLiteAPI>) throws -> Bool {
        try willDelete(db)
...
extension MutablePersistableRecord {
    ...
    @usableFromInline
    func deleteWithoutCallbacks(_ db: DatabaseBase<some SQLiteAPI>) throws -> Bool {
